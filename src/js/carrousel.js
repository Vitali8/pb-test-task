(function ($) {
  ...
  $.fn.mySlider = function (options) {
    ...
    function renderSlider(slider) {
      ...
      $('<div class="slider-nav"><button aria-label="left arrow button" class="arrow-left"></button><button aria-label="right arrow button" class="arrow-right"></button></div>').appendTo(".slider-wrap");
